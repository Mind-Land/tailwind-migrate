...
const DoctorRegister = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row h-screen md:h-fit">
        ...
        <div className="flex flex-col items-center justify-center w-full lg:w-1/2 px-4 py-8 bg-gray-100 dark:bg-gray-900">
          ...
          >
            ...
            <div className="flex items-center justify-center mt-2">
              <Link
                to="/login-doctor"
                className="text-primary-500 dark:text-white hover:underline"
              >
                Masuk
              </Link>
            </div>
